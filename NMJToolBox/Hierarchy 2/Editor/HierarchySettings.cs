...
namespace Hierarchy2
{
    ...
    internal class HierarchySettings : ScriptableObject
    {
        ...
        public struct ThemeData
        {
            ...
            public Color colorHeaderBackgroundInChildren;
            ...
            public ThemeData(ThemeData themeData)
            {
                ...
                colorHeaderBackgroundInChildren = themeData.colorHeaderBackgroundInChildren;
            }
            ...
            public void BlendMultiply(Color blend)
            {
                ...
                colorHeaderBackgroundInChildren = colorHeaderBackgroundInChildren * blend;
            }
        }
        ...
        public bool useSeparatorInChildren;
                ...
                activateHandler = (searchContext, rootElement) =>
                {
                    ...
                    IMGUIContainer instantBackgroundIMGUI = new IMGUIContainer(() =>
                    {
                        ...
                        EditorGUILayout.PropertyField(
                            new SerializedObject(settings).FindProperty(nameof(instantBackgroundColors)),
                            GUIContent.none);
                    ...
                    Toggle canUseSeparatorInChildrenGameObjects = new Toggle("Use Separator In Children");
                    canUseSeparatorInChildrenGameObjects.tooltip = "Only display while mouse hovering";
                    canUseSeparatorInChildrenGameObjects.StyleMarginTop(7);
                    canUseSeparatorInChildrenGameObjects.value = settings.useSeparatorInChildren;
                    canUseSeparatorInChildrenGameObjects.RegisterValueChangedCallback(evt =>
                    {
                        Undo.RecordObject(settings, "Change Settings");
                    ...
                    canUseSeparatorInChildrenGameObjects.StyleMarginLeft(CONTENT_MARGIN_LEFT);
                    verticalLayout.Add(canUseSeparatorInChildrenGameObjects);
                    ...
                    onlyDisplayWhileMouseHovering.RegisterValueChangedCallback((evt) =>
                    {
                        contentMaskEnumFlags.StyleDisplay(
                            evt.newValue);
                    });
                    ...
                    else
                    {
                        ...
                        ColorField colorHeaderBackgroundInChildren = new ColorField("Child Separator Background");
                        colorHeaderBackgroundInChildren.value = settings.usedTheme.colorHeaderBackgroundInChildren;
                        colorHeaderBackgroundInChildren.StyleMarginLeft(CONTENT_MARGIN_LEFT);
                        colorHeaderBackgroundInChildren.RegisterValueChangedCallback(evt =>
                        {
                            Undo.RecordObject(settings, "Change Settings");

                            if (EditorGUIUtility.isProSkin)
                                settings.professionalTheme.colorHeaderBackgroundInChildren = evt.newValue;
                            else
                                settings.personalTheme.colorHeaderBackgroundInChildren = evt.newValue;

                            settings.OnSettingsChanged();
                        });
                        verticalLayout.Add(colorHeaderBackgroundInChildren);
        ...
        {
            string path =
                EditorUtility.SaveFilePanelInProject("Export Hierarchy 2 settings as...", "Hierarchy 2 Settings",
                                                     "json", "");
            if (path.Length > 0)
            {
